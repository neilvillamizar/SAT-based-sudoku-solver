...
Para esta entrega se pudo actualizar la comparación de resultados. Ahora podemos evidenciar con mejor precisión los resultados para el resolvedor de zchaff. Se puede evidenciar que, aún después de introducidas las optimizaciones de compilación a nuestro resolvedor, el tiempo de ejecución de zchaff es mejor en todas las instancias, debido al gran número de optimizaciones que son implementadas en este resolvedor a diferencia del nuestro. Aún así, para estas instancias, el resolvedor propuesto por el grupo es suficientemente rápido como para ejecutar todas las instancias en menos de media décima de segundo.